...
public class ScenarioController {
     ...
     *
     * <p>값은 {@link ScenarioService#MAX_SWEEP_POINTS} 하나만 쓴다. 컨트롤러가 별도
     * 숫자를 들고 있으면 한쪽만 바뀌었을 때 REST와 직접 호출의 허용 범위가 어긋난다.
     */
    static final int MAX_SWEEP_POINTS = ScenarioService.MAX_SWEEP_POINTS;
